...
/**
 * Nielsen Process produce HNIW (CL-20)
 *
 * @author Magic_Sweepy (2023/12/10)
 *
 * <p>Produces HNIW (CL-20) and its full chemistry chain.</p>
 * <p>Simplified version of Full Nielsen Process (Nielsen, A.T., et al., 1990).</p>
 *
 */
