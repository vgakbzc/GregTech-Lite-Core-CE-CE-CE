...
public class SuprachronalAssemblyLine {
    ...
    public static void init() {
        ...
        SUPRACHRONAL_ASSEMBLY_LINE_RECIPES.recipeBuilder()
                .input(NITRONIC_SINGULARITY)
                .input(PSYCHOTIC_SINGULARITY)
                .input(FANTASTIC_SINGULARITY)
                .input(PNEUMATIC_SINGULARITY)
                .input(CRYPTIC_SINGULARITY)
                .input(HISTORIC_SINGULARITY)
                .input(METEORIC_SINGULARITY)
