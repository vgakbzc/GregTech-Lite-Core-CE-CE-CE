...
public class GTLiteTextures {
    ...
    public static final OrientedOverlayRenderer ELEMENT_REPLICATOR_OVERLAY = new OrientedOverlayRenderer("multiblocks/element_replicator");
    ...
    public static final GTLiteOverlayRenderer ELEMENT_CONSTRAINED_CASING = new GTLiteOverlayRenderer("casings/element_constrained_casing");
