...
public class GTLiteElements {
    ...
    public static final Element Cy   = addElement(888,    888,    "CrystalMatrix",             "◊◇◊");
    public static final Element If   = addElement(999,    999,    "Infinity",                  "∞");
    public static final Element Icx  = addElement(165,    280,    "Ichorium",                  "✦☯✧");
    public static final Element Ic   = addElement(165,    279,    "IchorLiquid",               "☯");
    public static final Element SpNt = addElement(9999,   9999,   "CosmicNeutronium",          "SpNt");
    public static final Element St   = addElement(10000,  10000,  "Spacetime",                 "");
    ...
    public static final Element Tix  = addElement(145,    133,    "AstralTitanium",            "✧◇✧");
    public static final Element Wx   = addElement(160,    101,    "CelestialTungsten",         "✦◆✦");
    ...
    public static final Element Mx   = addElement(1931,   1994,   "Magmatter",                 "M⎋");
    public static final Element Pi   = addElement(50000,  50000,  "PrimordialMatter",          "Pm⎋");
