...
public class GTLiteSecondDegreeMaterials {
    ...
    public static void register() {
        ...
        TitanSteel = new Material.Builder(getID(), gregtechId("titan_steel"))
                ...
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_ROD, GENERATE_GEAR, GENERATE_SMALL_GEAR, GENERATE_BOLT_SCREW, GENERATE_ROTOR, GENERATE_FRAME)
                .build();
        ...
        TranscendentMetal = new Material.Builder(getID(), gregtechId("transcendent_metal"))
                ...
                .flags(GENERATE_PLATE, GENERATE_DOUBLE_PLATE, GENERATE_DENSE, GENERATE_ROD, GENERATE_LONG_ROD, GENERATE_GEAR, GENERATE_SMALL_GEAR, GENERATE_BOLT_SCREW, GENERATE_RING, GENERATE_FRAME, GENERATE_ROTOR, GENERATE_ROUND)
                .build()
