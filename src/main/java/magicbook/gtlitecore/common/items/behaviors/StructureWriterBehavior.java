...
import magicbook.gtlitecore.api.pattern.JsonBlockPattern;
...
public class StructureWriterBehavior implements IItemBehaviour, ItemUIFactory {
    ...
    protected StructureWriterBehavior() {}

    @Override
    public ModularUI createUI(PlayerInventoryHolder playerInventoryHolder,
