...
public class MetaTileEntityReinforcedRotorHolder extends MetaTileEntityMultiblockPart implements IMultiblockAbilityPart<IReinforcedRotorHolder>, IReinforcedRotorHolder {
    ...
    public void addInformation(ItemStack stack,
        ...
        tooltip.add(I18n.format("gtlitecore.machine.reinforced_rotor_holder.tooltip.1"));
        tooltip.add(I18n.format("gtlitecore.machine.reinforced_rotor_holder.tooltip.2"));
    ...
    public MultiblockAbility<IReinforcedRotorHolder> getAbility() {
        return GTLiteMultiblockAbility.REINFORCED_ROTOR_HOLDER_ABILITY;
    }
    ...
    public void setRotor(ItemStack itemStack) {
        ...
        if (!getWorld().isRemote) {
            writeCustomData(GTLiteDataCode.ChannelReinforcedRotorHolder, buf -> buf.writeInt(rotorColor));
            markDirty();
        }
    }
    ...
    public void receiveCustomData(int dataId, PacketBuffer buf) {
        ...
        } else if (dataId == GTLiteDataCode.ChannelReinforcedRotorHolder) {
