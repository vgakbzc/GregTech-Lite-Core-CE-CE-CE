...
public class MetaTileEntityBudgetCRIBA8 extends MetaTileEntityMultiblockNotifiablePart
    ...
    public MetaTileEntityBudgetCRIBA8(ResourceLocation metaTileEntityId) {
    ...
    protected void initializeInventory() {
        ...
        this.patternSlot = new ItemStackHandler(8) {
        ...
        this.extraItem = new NotifiableItemStackHandler(this, 3, null, false) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityBudgetCRIBA8(metaTileEntityId);
    }
    ...
    protected ModularUI createUI(EntityPlayer entityPlayer) {
        ...
        for(int i=0;i<8;i++) {
            pattern.addWidget(new SlotWidget(patternSlot, i, (i%2)*18, (i/2)*18)
        ...
        WidgetGroup buttons = new WidgetGroup(new Position(7+18, (int) (18 * 5.25) + 3));
        ...
        buttons.addWidget(new SlotWidget(extraItem, 2, 36, 0)
                .setBackgroundTexture(GuiTextures.SLOT).setTooltipText("gtlitecore.machine.budget_crib.extra_item"));
        // Circuit slot
        buttons.addWidget(new GhostCircuitSlotWidget(circuitInventory, 0, 54, 0)
                .setBackgroundTexture(GuiTextures.SLOT, GuiTextures.INT_CIRCUIT_OVERLAY)
                .setConsumer(this::getCircuitSlotTooltip));

        // Blocking toggle
        buttons.addWidget(new ImageCycleButtonWidget(18 * 4, 0, 18, 18, GuiTextures.BUTTON_POWER,
                this::isWorkingEnabled, this::setWorkingEnabled)
                .setTooltipHoverString("gtlitecore.machine.budget_crib.blocking_button"));

        // Return items
        buttons.addWidget(new ClickButtonWidget(18 * 5, 0, 18, 18, "", (clickData) -> returnItems())
