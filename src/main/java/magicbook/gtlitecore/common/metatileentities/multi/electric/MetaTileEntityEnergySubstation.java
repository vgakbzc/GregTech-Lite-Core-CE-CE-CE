...
public class MetaTileEntityEnergySubstation extends MultiblockWithDisplayBase implements IControllable, IProgressBarMultiblock {
    ...
    protected BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start(RIGHT, FRONT, UP)
                ...
                .aisle("GGGGG", "GBBBG", "GBBBG", "GBBBG", "GGGGG").setRepeatable(4, MAX_CELL_LAYERS)
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        ...
        MultiblockShapeInfo.Builder builder = MultiblockShapeInfo.builder()
                .aisle("CCMCC", "GGGGG", "GGGGG", "GGGGG", "GGGGG", "CCCCC")
                .aisle("CCCCC", "GBBBG", "GBBBG", "GBBBG", "GBBBG", "CCCCC")
                .aisle("CCCCC", "GBBBG", "GBBBG", "GBBBG", "GBBBG", "CCCCC")
                .aisle("CCCCC", "GBBBG", "GBBBG", "GBBBG", "GBBBG", "CCCCC")
                .aisle("INSTO", "GGGGG", "GGGGG", "GGGGG", "GGGGG", "CCCCC")
                .where('S', GTLiteMetaTileEntities.ENERGY_SUBSTATION, EnumFacing.SOUTH)
    ...
    protected IBlockState getCasingState() {
        return GTLiteMetaBlocks.SUPPORT_CASING.getState(BlockSupportCasing.SupportCasingType.SUBSTATION_EXTERNAL_CASING);
    }
    ...
    public ICubeRenderer getBaseTexture(IMultiblockPart sourcePart) {
        return GTLiteTextures.SUBSTATION_EXTERNAL_CASING;
    }
    ...
    protected void addDisplayText(List<ITextComponent> textList) {
        MultiblockDisplayText.builder(textList, this.isStructureFormed())
                ...
                .setWorkingStatusKeys(
                        "gtlitecore.machine.energy_substation.idling",
                        "gtlitecore.machine.energy_substation.paused",
                        "gtlitecore.machine.energy_substation.running")
                .addCustom(tl -> {
                    if (this.isStructureFormed() && energyBank != null) {
                        ...
                        tl.add(TextComponentUtil.translationWithColor(
                                TextFormatting.GRAY,
                                "gtlitecore.machine.energy_substation.stored",
                                storedFormatted));
                        ...
                        tl.add(TextComponentUtil.translationWithColor(
                                TextFormatting.GRAY,
                                "gtlitecore.machine.energy_substation.capacity",
                                capacityFormatted));
                        ...
                        ITextComponent hover = TextComponentUtil.translationWithColor(
                                TextFormatting.GRAY,
                                "gtlitecore.machine.energy_substation.average_in_hover");
                        ...
                        hover = TextComponentUtil.translationWithColor(
                                TextFormatting.GRAY,
                                "gtlitecore.machine.energy_substation.average_out_hover");
                        tl.add(TextComponentUtil.setHover(base, hover));
    ...
    public void addInformation(ItemStack stack,
        ...
        tooltip.add(I18n.format("gtlitecore.machine.energy_substation.tooltip.3"));
        tooltip.add(I18n.format("gtlitecore.machine.energy_substation.tooltip.4", MAX_CELL_LAYERS));
        tooltip.add(I18n.format("gtlitecore.machine.energy_substation.tooltip.5"));
        tooltip.add(I18n.format("gtlitecore.machine.energy_substation.tooltip.6", PASSIVE_DRAIN_MAX_PER_STORAGE));
        tooltip.add(I18n.format("gtlitecore.machine.energy_substation.tooltip.7"));
        tooltip.add(I18n.format("gtlitecore.machine.energy_substation.tooltip.8"));
    }
