...
public class MetaTileEntityBudgetCRIBA12 extends MetaTileEntityMultiblockNotifiablePart
    ...
    public MetaTileEntityBudgetCRIBA12(ResourceLocation metaTileEntityId) {
    ...
    protected void initializeInventory() {
        ...
        this.patternSlot = new ItemStackHandler(12) {
        ...
        this.extraItem = new NotifiableItemStackHandler(this, 4, null, false) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityBudgetCRIBA12(metaTileEntityId);
    }
    ...
    protected ModularUI createUI(EntityPlayer entityPlayer) {
        ...
        // Circuit slot
        buttons.addWidget(new GhostCircuitSlotWidget(circuitInventory, 0, 72, 0)
                .setBackgroundTexture(GuiTextures.SLOT, GuiTextures.INT_CIRCUIT_OVERLAY)
                .setConsumer(this::getCircuitSlotTooltip));

        // Blocking toggle
        buttons.addWidget(new ImageCycleButtonWidget(18 * 5, 0, 18, 18, GuiTextures.BUTTON_POWER,
