...
import magicbook.gtlitecore.api.capability.impl.LargeSlotItemStackHandler;
...
public class MetaTileEntitySingleInputBus extends MetaTileEntityMultiblockNotifiablePart
    ...
    public MetaTileEntitySingleInputBus(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, GTValues.HV, false);
    }

    @Override
    protected void initializeInventory() {
        this.largeSlotItemStackHandler = new LargeSlotItemStackHandler(this, 1, null, false, () -> this.slotLimit);
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntitySingleInputBus(metaTileEntityId);
    }
    ...
    protected ModularUI createUI(EntityPlayer entityPlayer) {
        ModularUI.Builder builder = ModularUI.builder(GuiTextures.BACKGROUND, 176, 18 + 18 * 2 + 94)
                .label(6, 6, getMetaFullName());

        WidgetGroup slots = new WidgetGroup(new Position(7 + (int) (18 * 2.5), 18));
        // Item slots
        slots.addWidget(new ItemSlotTinyAmountTextWidget(this.largeSlotItemStackHandler, 0,
                27, 0, false, false)
                .setBackgroundTexture(GuiTextures.SLOT));

        WidgetGroup extraWidgets = new WidgetGroup(new Position(7, 18 * 2 + 9));

        // Slot limit
        extraWidgets.addWidget(new ImageWidget(0, 0, 18 * 4, 20, GuiTextures.DISPLAY)
                .setTooltip("gtlitecore.machine.super_input_bus.slot_limit"));
        ...
        // Auto pull
        extraWidgets.addWidget(new ToggleButtonWidget(18 * 7, 0, 18, 18, GTLiteGuiTextures.AUTO_PULL,
                this::isWorkingEnabled, this::setWorkingEnabled)
                .shouldUseBaseBackground()
                .setTooltipText("gtlitecore.machine.super_input_bus.auto_pull"));
        ...
        extraWidgets.addWidget(new ToggleButtonWidget(18 * 8, 0, 18, 18, GuiTextures.BUTTON_ITEM_OUTPUT,
                ...
                .setTooltipText("gtlitecore.machine.super_input_bus.return_items.button")
                .shouldUseBaseBackground());

        return builder.bindPlayerInventory(entityPlayer.inventory, GuiTextures.SLOT, 7, 18 + 18 * 2 + 12)
                .widget(slots)
                .widget(extraWidgets)
    ...
    public void update() {
        ...
        if (!getWorld().isRemote) {
            ...
            if (shouldReturnItems) {
                ...
                if (isInventoryEmpty(this.largeSlotItemStackHandler)) {
    ...
    public void addToMultiBlock(MultiblockControllerBase controllerBase) {
        ...
        addNotifiableToMTE(this.actualImportItems, controllerBase, this, false);
    }
    ...
    public void removeFromMultiBlock(MultiblockControllerBase controllerBase) {
        ...
        removeNotifiableFromMTE(this.actualImportItems, controllerBase);
    }
    ...
    public boolean onScrewdriverClick(EntityPlayer playerIn, EnumHand hand, EnumFacing facing,
        ...
        if (shouldReturnItems()) {
            ...
            playerIn.sendStatusMessage(
                    new TextComponentTranslation("gtlitecore.machine.super_input_bus.return_items.screwdriver.disabled"),
                    true);
        } else {
            setReturningItems(true);
            playerIn.sendStatusMessage(
                    new TextComponentTranslation("gtlitecore.machine.super_input_bus.return_items.screwdriver.enabled"),
                    true);
        }
    ...
    public void addToolUsages(ItemStack stack, World world, List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("gtlitecore.machine.super_input_bus.screwdriver"));
        tooltip.add(I18n.format("gtlitecore.machine.super_input_bus.soft_mallet"));
