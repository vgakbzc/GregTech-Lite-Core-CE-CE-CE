...
public class MetaTileEntityCatalystHatch extends MetaTileEntityMultiblockPart implements IMultiblockAbilityPart<ICatalystHatch>, ICatalystHatch {
    ...
    public void renderMetaTileEntity(CCRenderState renderState,
        ...
        if (this.shouldRenderOverlay()) {
            GTLiteTextures.MULTIPART_CATALYST_HATCH.renderSided(getFrontFacing(), renderState, translation, pipeline);
        }
    }
    ...
    protected ModularUI createUI(EntityPlayer entityPlayer) {
        ModularUI.Builder builder = ModularUI.builder(GuiTextures.BACKGROUND, 176, 209)
                ...
                .widget(new SlotWidget(this.catalystHolder, 0, 88 - 9, 50, true, true, true)
                        .setBackgroundTexture(GuiTextures.SLOT)
                        .setChangeListener(this::markDirty))
                .widget(new LabelWidget(88, 20, "gtlitecore.machine.large_chemical_complex.catalyst_hatch.only")
                        .setXCentered(true));
    ...
    public <T> T getCapability(Capability<T> capability, EnumFacing side) {
        return capability == CapabilityItemHandler.ITEM_HANDLER_CAPABILITY ?
                CapabilityItemHandler.ITEM_HANDLER_CAPABILITY.cast(this.catalystHolder) : super.getCapability(capability, side);
    }
    ...
    public MultiblockAbility<ICatalystHatch> getAbility() {
        return GTLiteMultiblockAbility.CATALYST_MULTIBLOCK_ABILITY;
    }
