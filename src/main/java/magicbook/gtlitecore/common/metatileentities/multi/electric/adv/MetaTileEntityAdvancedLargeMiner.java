...
public class MetaTileEntityAdvancedLargeMiner extends MultiblockWithDisplayBase implements IMiner, IControllable, IDataInfoProvider {
    ...
    public IBlockState getCasingState() {
        if (this.material.equals(Materials.Protactinium)) {
            return GTLiteMetaBlocks.METAL_CASING.getState(magicbook.gtlitecore.common.blocks.BlockMetalCasing.MetalCasingType.PROTACTINIUM_CASING);
        } else {
            return this.material.equals(Materials.Einsteinium) ? GTLiteMetaBlocks.METAL_CASING.getState(magicbook.gtlitecore.common.blocks.BlockMetalCasing.MetalCasingType.EINSTEINIUM_CASING) : GTLiteMetaBlocks.METAL_CASING.getState(BlockMetalCasing.MetalCasingType.MENDELEVIUM_CASING);
        }
    }
    ...
    private TraceabilityPredicate getFrameState() {
        if (this.material.equals(Materials.Protactinium)) {
            ...
            return this.material.equals(Materials.Einsteinium) ? frames(Materials.Einsteinium) : frames(Materials.Mendelevium);
        }
    }
    ...
    public ICubeRenderer getBaseTexture(IMultiblockPart sourcePart) {
        if (this.material.equals(Materials.Protactinium)) {
            return GTLiteTextures.PROTACTINIUM_CASING;
        } else {
            return this.material.equals(Materials.Einsteinium) ? GTLiteTextures.EINSTEINIUM_CASING : GTLiteTextures.MENDELEVIUM_CASING;
        }
    }
