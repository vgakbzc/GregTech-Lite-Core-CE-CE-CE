...
public class MetaTileEntityBudgetCRIBA16 extends MetaTileEntityMultiblockNotifiablePart
    ...
    public MetaTileEntityBudgetCRIBA16(ResourceLocation metaTileEntityId) {
    ...
    protected void initializeInventory() {
        ...
        this.patternSlot = new ItemStackHandler(16) {
        ...
        this.extraItem = new NotifiableItemStackHandler(this, 5, null, false) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityBudgetCRIBA16(metaTileEntityId);
    }
    ...
    protected ModularUI createUI(EntityPlayer entityPlayer) {
        ...
        for(int i=0;i<16;i++) {
            pattern.addWidget(new SlotWidget(patternSlot, i, (i%4)*18, (i/4)*18)
                    .setBackgroundTexture(GuiTextures.SLOT, GTLiteGuiTextures.ME_PATTERN_OVERLAY));
        }

        // Item slots
        WidgetGroup slots = new WidgetGroup(new Position(7 + 18 * 4, 20));
        for (int y = 0; y <= 3; y++) {
            for (int x = 0; x <= 3; x++) {
                int index = y * 4 + x;
        ...
        // Circuit slot
        buttons.addWidget(new GhostCircuitSlotWidget(circuitInventory, 0, 90, 0)
                .setBackgroundTexture(GuiTextures.SLOT, GuiTextures.INT_CIRCUIT_OVERLAY)
                .setConsumer(this::getCircuitSlotTooltip));

        // Blocking toggle
        buttons.addWidget(new ImageCycleButtonWidget(18 * 6, 0, 18, 18, GuiTextures.BUTTON_POWER,
                this::isWorkingEnabled, this::setWorkingEnabled)
                .setTooltipHoverString("gtlitecore.machine.budget_crib.blocking_button"));

        // Return items
        buttons.addWidget(new ClickButtonWidget(18 * 7, 0, 18, 18, "", (clickData) -> returnItems())
