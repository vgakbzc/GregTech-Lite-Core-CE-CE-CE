...
public class MetaTileEntityExtremeHeatExchanger extends NoEnergyMultiblockController implements IHeatExchanger {

    private final int parallel = 32;
    private final int heatTime = 150 * 8;
    private int thresholdPercentage = 100;

    public MetaTileEntityExtremeHeatExchanger(ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityExtremeHeatExchanger(metaTileEntityId);
    }
