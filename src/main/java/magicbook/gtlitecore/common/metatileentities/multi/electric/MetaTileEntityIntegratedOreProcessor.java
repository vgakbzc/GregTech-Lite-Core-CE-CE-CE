...
import magicbook.gtlitecore.api.capability.impl.OreProcessorRecipeLogic;
...
public class MetaTileEntityIntegratedOreProcessor extends MultiblockWithDisplayBase implements IDataInfoProvider {
    ...
    protected void addDisplayText(List<ITextComponent> textList) {
        ...
        if (isStructureFormed()) {
            ...
            switch (logic.getMode()) {
                case 0 -> textList.add(new TextComponentTranslation("gtlitecore.machine.integrated_ore_processor.mode.0"));
                case 1 -> textList.add(new TextComponentTranslation("gtlitecore.machine.integrated_ore_processor.mode.1"));
                case 2 -> textList.add(new TextComponentTranslation("gtlitecore.machine.integrated_ore_processor.mode.2"));
                case 3 -> textList.add(new TextComponentTranslation("gtlitecore.machine.integrated_ore_processor.mode.3"));
                case 4 -> textList.add(new TextComponentTranslation("gtlitecore.machine.integrated_ore_processor.mode.4"));
                default -> textList.add(new TextComponentTranslation("gtlitecore.machine.integrated_ore_processor.mode.error"));
            }
            if (!drainEnergy(true)) {
    ...
    public void addInformation(ItemStack stack,
        ...
        if (Keyboard.isKeyDown(Keyboard.KEY_LSHIFT)) {
            tooltip.add(I18n.format("gtlitecore.machine.integrated_ore_processor.tooltip_shift.1"));
            tooltip.add(I18n.format("gtlitecore.machine.integrated_ore_processor.tooltip_shift.2"));
        } else {
    ...
    public final boolean onScrewdriverClick(EntityPlayer playerIn,
        ...
        if (playerIn.isSneaking()) {
            ...
            if (playerIn.getEntityWorld().isRemote) {
                playerIn.sendMessage( new TextComponentTranslation("gtlitecore.machine.integrated_ore_processor.void." + logic.isVoidStone()));
            }
        } else {
    ...
    public List<ITextComponent> getDataInfo() {
        ...
        if (logic.getMode() < 5 && logic.getMode() >= 0) {
            list.add(new TextComponentTranslation("gtlitecore.machine.integrated_ore_processor.mode." + logic.getMode()));
        }
        return list;
    }
