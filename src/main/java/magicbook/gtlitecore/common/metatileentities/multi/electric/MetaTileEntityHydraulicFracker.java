...
public class MetaTileEntityHydraulicFracker extends MultiblockWithDisplayBase implements IWorkable, ITieredMetaTileEntity {
    ...
    public MetaTileEntityHydraulicFracker(ResourceLocation metaTileEntityId, int tier) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityHydraulicFracker(this.metaTileEntityId, this.tier);
    }
    ...
    protected boolean drainTanks(@SuppressWarnings("SameParameterValue") int amount, boolean simulate) {
        ...
        return stack != null && stack.isFluidEqual(GTLiteMaterials.FracuringFluid.getFluid(1)) && stack.amount == FLUID_USE_AMOUNT;
    }
    ...
    public void addInformation(ItemStack stack,
        ...
        tooltip.add(I18n.format("gtlitecore.machine.hydraulic_fracker.tooltip.2", TextFormattingUtil.formatNumbers(GTValues.VA[tier])));
    }
