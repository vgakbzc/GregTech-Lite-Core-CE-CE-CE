...
import magicbook.gtlitecore.api.capability.impl.AdvancedFluidDrillLogic;
...
public class MetaTileEntityAdvancedFluidDrill extends MultiblockWithDisplayBase implements ITieredMetaTileEntity, IWorkable, IProgressBarMultiblock {
    ...
    private IBlockState getCasingState() {
        if (this.tier == 5) {
            return GTLiteMetaBlocks.METAL_CASING.getState(magicbook.gtlitecore.common.blocks.BlockMetalCasing.MetalCasingType.HSS_G_CASING);
        } else if (this.tier == 6) {
            return MetaBlocks.METAL_CASING.getState(BlockMetalCasing.MetalCasingType.HSSE_STURDY);
        } else {
            return this.tier == 7 ? GTLiteMetaBlocks.METAL_CASING.getState(magicbook.gtlitecore.common.blocks.BlockMetalCasing.MetalCasingType.HSS_S_CASING) : GTLiteMetaBlocks.METAL_CASING.getState(magicbook.gtlitecore.common.blocks.BlockMetalCasing.MetalCasingType.INCOLOY_MA_813_CASING);
        }
    }
    ...
    private TraceabilityPredicate getFrameState() {
        if (this.tier == 5) {
            ...
            return this.tier == 7 ? frames(Materials.HSSS) : frames(GTLiteMaterials.IncoloyMA813);
        }
    }
    ...
    public ICubeRenderer getBaseTexture(IMultiblockPart sourcePart) {
        if (this.tier == 5) {
            return GTLiteTextures.HSS_G_CASING;
        } else if (this.tier == 6) {
            return Textures.STURDY_HSSE_CASING;
        } else {
            return this.tier == 7 ? GTLiteTextures.HSS_S_CASING : GTLiteTextures.INCOLOY_MA_813_CASING;
        }
    }
